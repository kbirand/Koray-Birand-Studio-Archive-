...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WeTransfer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// A base class to handle NSOperation states, because this is quite verbose due to KVO and the combined attribute states.
SWIFT_CLASS("_TtC10WeTransfer21AsynchronousOperation")
